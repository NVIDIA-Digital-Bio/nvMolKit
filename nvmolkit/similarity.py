...
def crossTanimotoSimilarity(fingerprint_group_one: AsyncGpuResult | torch.Tensor,
                            ...
                            stream: torch.cuda.Stream | None = None) -> AsyncGpuResult:
...
def crossCosineSimilarity(fingerprint_group_one: AsyncGpuResult | torch.Tensor,
                          fingerprint_group_two: AsyncGpuResult | torch.Tensor | None = None,
                          stream: torch.cuda.Stream | None = None) -> AsyncGpuResult:
    ...
    if fingerprint_group_two is not None:
        return AsyncGpuResult(_DataStructs.CrossCosineSimilarityRawBuffers(fingerprint_group_one.__cuda_array_interface__,
                                                              fingerprint_group_two.__cuda_array_interface__, stream_ptr))
    return AsyncGpuResult(_DataStructs.CrossCosineSimilarityRawBuffers(fingerprint_group_one.__cuda_array_interface__,
                                                          fingerprint_group_one.__cuda_array_interface__, stream_ptr))
