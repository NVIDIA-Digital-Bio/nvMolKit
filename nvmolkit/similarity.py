...
# --------------------------------
# CPU result helpers (not exposing options; Python side always uses default/nullopt)
# --------------------------------
...
def crossTanimotoSimilarityMemoryConstrained(fingerprint_group_one: torch.Tensor,
    ...
    Expects fingerprints generated by nvMolKit by nvMolKit or as a torch tensor located on device 0, with the leading dimension corresponding to
    the number of fingerprints, and the second dimension representing the packed fingerprint
    bitfield.
