...
# TODO: fix location of hardwareOptions.
...
def MMFFOptimizeMoleculesConfs(
    ...
    hardwareOptions: BatchHardwareOptions | None = None
) -> list[list[float]]:
    ...
    Note:
        ...
        - For best performance, ensure molecules have conformers pre-generated
        - The function automatically handles molecules with different numbers of atoms
        - GPU memory usage scales with total number of conformers and molecule size
    """
    # Validate input
    if not molecules:
        return []
